...
public class KidstaffHomePage extends BasePage {
 public KidstaffHomePage (WebDriver driver ){     super(driver);}
    ...
    public WebElement getKidsCloth(){ return waitElementToBeVisible("(//span[text()='Дитячий гардероб'])[2] ");}
    public WebElement getArrowReturnMenu(){return waitElementToBeVisible("//div[@class='panel-block menu-header']//a[contains(@class,'icon menu-back')]");}
    ...
    public WebElement getLanguageSwitcherUa(){return waitElementToBeVisible("//a[contains(text(),'UA')]");}
   public WebElement getLanguageSwitcherRu(){return waitElementToBeVisible("//a[contains(text(),'ru')]");}
    ...
    public void goBack () {driver.quit();}
